...
export const deposit = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const result = await UserService.deposit(req.userId, req.body);
    res.status(200).json(result);
  } catch (error) {
...
export const withdraw = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const result = await UserService.withdraw(req.userId, req.body);
    res.status(200).json(result);
  } catch (error) {
...
export const getTransactions = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    const result = await UserService.getTransactions(req.userId, limit, offset);
    res.status(200).json(result);
  } catch (error) {
...
export const updateClock = async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    await UserService.updateClock(req.userId, minute);
